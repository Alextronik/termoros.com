...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"MESS_PICKUP_LIST" => "Выбрать склад:",
		...
		"IS_PARTNER" => \Redreams\Partners\partner::isPartner() ? "Y" : "N",
		"IS_OPERATOR" => \Redreams\Partners\partner::isOperator() ? "Y" : "N"
	),
	false

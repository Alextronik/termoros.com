...
if ($_GET['custom'] == 'Y' && !$rBrands && !$rTypes && !$rStores)
{
...
foreach($xml->Dat as $o)
{
	foreach($o->Attributes() as $k => $v)
	{
		...
		$item['link'] = 'https://www.termoros.com/catalog/element.php?a='.$item['article'].'&utm_source=file&utm_medium=price_list&utm_campaign='.$brandLower;

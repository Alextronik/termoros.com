...
<div class='delivery_section'>
	...
	<p class="loc">Местоположение: г. <b><?=$_SESSION['GEOIP']['curr_city_name'] ? $_SESSION['GEOIP']['curr_city_name'] : $_SESSION['GEOIP']['city']?></b><a href=""><b>изменить</b></a></p>
	<? if ($_SESSION['STORES'][$_SESSION['GEOIP']['curr_city_name']]['STORE_NAME']) { ?><p class="loc">Выбранный склад: г. <b><?=$_SESSION['STORES'][$_SESSION['GEOIP']['curr_city_name']]['STORE_NAME']?></b><a href=""><b>изменить</b></a></p><? } ?>
	<?
			...
			else // stores and courier
			{
				...
				?>
					<div class='dt_list'>
						...
						<div class='dt_item'>
							<?if($arResult["DELIVERY_PRICE"] && $arDelivery["PRICE"]):?><?=$arDelivery["PRICE_FORMATED"]?><?endif;?>
						</div>
						...
						<div class='dt_item'>
							...
							?>
							<? if ($arDelivery["ID"] == 44) { ?>
								<span id="cdekDeliveryID"></span>
								<?/*
								<script id="ISDEKscript" type="text/javascript" src="/store/cdek/pvzwidget/widget/widjet.js"></script>
								<br>
								<b><a href='javascript:void(0);' onclick='ourWidjet.open(); $(".slide_panel").hide();'>Рассчитать стоимость доставки</a></b>

...
?><?if(is_ajax()&&$_REQUEST['TYPE']=='REGISTRATION'):?>
	<?ajax_start();?>
<?endif?>

<div class='form_inn'>
		<a href='' class='close'></a>
		<p class='ttl'>регистрация<a class='go_log'>вход</a></p>
<?//p($_REQUEST)?>
...
<?if($arResult['REGISTER_DONE'] == 'Y'):?>
	...
	<?else:?>
		<p>Вы успешно зарегистрировались! Перейти в <a href="">Личный кабинет</a></p>
	<?endif?>
<?else:?>
	...
	<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
		...
		?>
			<input type="submit" name="register_submit_button" class='enter' value='Зарегистрироваться'/>
		<div class='clear'></div>

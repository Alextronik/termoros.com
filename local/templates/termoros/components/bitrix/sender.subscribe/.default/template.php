...
?>
	...
	<form role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>"  onsubmit="BX('bx_subscribe_btn_<?=$buttonId?>').disabled=true;">
		...
		<div class="subs_wp">
			...
			<input type='text' class='inp_self' name="SENDER_SUBSCRIBE_EMAIL" value='<?=$arResult["EMAIL"]?>' placeholder='Ваш e-mail'><input type='submit' id="bx_subscribe_btn_<?=$buttonId?>" class='btn' value='Подписаться' >	
		</div>

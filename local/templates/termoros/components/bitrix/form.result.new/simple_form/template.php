...
?>
	...
	<?if ($arResult['FORM_ERRORS']) { ?>
		<?foreach($arResult['FORM_ERRORS'] as $err) { ?>
	...
	<?foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion):?>
			<?//p($arQuestion)?>
				...
				<div class='insert_area f_area file_wp'>
					...
					<a onclick="$(this).parent().find('.file_form').click(); $(this).parents('form').attr('id','test_form');" class='file_but insert_file'>Прикрепить фаил <?if($arQuestion['REQUIRED']=='Y'):?>*<?endif;?></a>

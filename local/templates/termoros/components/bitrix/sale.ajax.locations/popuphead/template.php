...
<input
	placeholder='Введите название города' class='inp_self'
	size="<?=$arParams["SIZE1"]?>"
...
<input type="hidden" name="<?echo $arParams["CITY_INPUT_NAME"]?>" id="<?echo $arParams["CITY_INPUT_NAME"]?>" class="city_tmp_id" value="<?=$arParams["LOCATION_VALUE"]?>">

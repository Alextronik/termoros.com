...
if (0 < $arResult['SECTIONS_COUNT'])
{
	...
	foreach ($arResult['SECTIONS'] as $key => &$arSection)
	{
		...
		$arFilter = array('IBLOCK_ID' => $arSection['IBLOCK_ID'],'>LEFT_MARGIN' => $arSection['LEFT_MARGIN'],'<RIGHT_MARGIN' => $arSection['RIGHT_MARGIN'],'DEPTH_LEVEL' => $arSection['DEPTH_LEVEL']+1, 'ACTIVE'=>"Y");
		$rsSect = CIBlockSection::GetList(array('left_margin' => 'asc'),$arFilter,false,$arSelect);
		while ($arSect = $rsSect->GetNext())
		{
			$arSection["SECTION_VIST"][]=$arSect;
		}

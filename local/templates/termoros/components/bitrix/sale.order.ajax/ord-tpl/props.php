...
<div class='oc_right'>
	<?
	if($arResult["ORDER_PROP"]["USER_PROPS_Y"][1]['SOURCE'] == 'DEFAULT')
		$arResult["ORDER_PROP"]["USER_PROPS_Y"][1]['VALUE'] = '';
	
	//PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"], 1);
	PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_Y"], $arParams["TEMPLATE_LOCATION"], 1);
	PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_Y"], $arParams["TEMPLATE_LOCATION"], 3);
	?>	
	<?
	//PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"], 3, 2);
	//PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_Y"], $arParams["TEMPLATE_LOCATION"], 3, 2);
	?>
	<a href='' class='next_step fst-step'>Продолжить</a>
</div>

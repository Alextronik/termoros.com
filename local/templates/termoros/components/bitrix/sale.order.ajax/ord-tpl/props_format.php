...
{
	function PrintPropsForm($arSource = array(), $locationTemplate = ".default", $GrpNumb = false, $propId = false, $loc = false, $req = false)
	{
		if (!empty($arSource))
		{
			?>
				...
				{
					if($GrpNumb && $GrpNumb != $arProperties['PROPS_GROUP_ID']) continue;
					if($loc&&($arProperties["CODE"] != 'LOCATION')) continue;
					...
					?>
						...
						if ($arProperties["TYPE"] == "CHECKBOX")
						{
							...
							<div class='check_wp'>
								...
								<input class='customCheckbox' type="checkbox" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" value="Y"<?if ($arProperties["CHECKED"]=="Y") echo " checked";?>>
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							...
							<span class="contain">
								...
								<input placeholder="<?=$arProperties["NAME"];?>" class='inp_self<?if($arProperties["CODE"] != 'STREET'):?> short<?endif;?><?if($arProperties["CODE"] == 'KV'):?> last<?endif;?>' type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" <?if ($arProperties["REQUIED_FORMATED"]=="Y"||$req):?><?if($arProperties['CODE'] == 'EMAIL'):?>data-email="1"<?elseif($arProperties['CODE'] == 'PHONE'):?>data-phone="1"<?else:?>data-req="1"<?endif?><?endif?> value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" />
						...
						elseif ($arProperties["TYPE"] == "TEXTAREA")
						{
							...
							<textarea placeholder="<?=$arProperties["NAME"];?>" class='inp_self' rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"><?=$arProperties["VALUE"]?></textarea>
						...
						{
							?>
							<div class="bx_block r3x1 location" >
								<?
								$value = 0;

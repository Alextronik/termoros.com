			...
			<?
					foreach ($arSource as $arProperties)
					{
						...
						if ($arProperties["TYPE"] == "CHECKBOX")
						{
							...
							<input data-error_mes="Для заказа вы должны подтвердить свой возраст!"  type="checkbox" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" <?=in_array($arProperties["FIELD_NAME"],$arrValid)?'data-req="1"':""?> class="customCheckbox"  value="Y"<?if ($arProperties["CHECKED"]=="Y") echo " checked";?>>

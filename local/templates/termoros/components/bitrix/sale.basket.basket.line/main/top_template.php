...
<?endif?>
	<div class="bx-basket-block"><?
		...
		{
			?>
			<a class="link" onclick="yaCounter26951046.reachGoal('pereiti_korzina'); ga('send', 'pageview','/virtual/pereiti_korzina'); return true;" href="<?= $arParams['PATH_TO_BASKET'] ?>"><span><?= GetMessage('TSB1_CART') ?></span><i class="fas fa-sort-down"></i></a><?
		}
		...
		if (!$compositeStub)
		{
		    ...
		    if ($arParams['SHOW_NUM_PRODUCTS'] == 'Y' && ($arResult['NUM_PRODUCTS'] > 0 || $arParams['SHOW_EMPTY_VALUES'] == 'Y'))
			{
				...
				{
					?>
                    <span class="summ1"><?=$arResult['NUM_PRODUCTS'].' шт. ';?></span>
                    <span class="summ2"><?=$arResult['TOTAL_PRICE']?></span>
					<?
				}
			}
		    echo "</div>";
